...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	papel1.LoadTGA("papel.tga");
	papel1.BuildGLTexture();
	papel1.ReleaseImage();
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glTranslatef(-8,1,-7);
		fig1.cono(6,3,30, arbol1.GLindex);
		...
		fig1.cilindro(1, 1, 30, tronco.GLindex);
		...
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera2//////////////////////
		...
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera5//////////////////////
		glTranslatef(1, -1.5, -1.6);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera6//////////////////////
		glTranslatef(0, 0, 3.8);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera7//////////////////////
		glTranslatef(2.1, 0, -1.9);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera8//////////////////////
		glTranslatef(-3.8, 0, 0);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera9//////////////////////
		glTranslatef(1.1, -1.5, 2.5);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera10//////////////////////
		glTranslatef(2, 0, -0.2);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera11//////////////////////
		glTranslatef(1.4, 0, -1.5);
		fig1.esfera(0.2, 30, 30, esfe.GLindex);
		////////////////Esfera12//////////////////////
		...
		glTranslatef(-8, 0.5, -4);

		fig1.prisma2(papel1.GLindex, papel1.GLindex);

		glTranslatef(0, 0.6, 0);

		fig1.prisma(0.8,0.8,0.0, moño.GLindex);
